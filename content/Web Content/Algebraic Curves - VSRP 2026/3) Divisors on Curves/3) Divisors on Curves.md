---
publish: true
created: 2026-07-19T13:19:42.522Z
modified: 2026-09-13T06:09:26.502Z
---
...
From [[#^be3f40|Proposition]] 3.3, any non-constant map between complete non-singular curves is finite dominant. Hence $f^*: \Div Y \to \Div X$, as in [[1.5) Behavior of Divisors under Finite Dominant Maps#^64368c|Definition]] 1.5.2 makes sense.
...
Further, for finite dominant morphism of curves, the relative degree, as in [[1.5) Behavior of Divisors under Finite Dominant Maps#^bff06b|Definition]] 1.5.5 also becomes simple.
...
So, for curves, [[1.5) Behavior of Divisors under Finite Dominant Maps#^a5ce59|Proposition]] 1.5.6 simplifies to the following
...
> [!proof]- _Proof_:
> This follows from [[1.5) Behavior of Divisors under Finite Dominant Maps#^a5ce59|Proposition]] 1.5.6 since $\textnormal{deg}_f = \deg$
...
> \
> Using this with [[1.4) Maps to Projective Spaces and Linear Systems#^dacdae|Lemma]] 1.4.13 we are done.
